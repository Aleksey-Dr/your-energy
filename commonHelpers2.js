import"./assets/styles-93a1f0b4.js";import{a as w,i as I,P as V,g as j}from"./assets/vendor-5014e6d0.js";(()=>{const t=document.querySelector(".js-mobile-menu"),e=document.querySelector(".js-open-menu"),s=document.querySelector(".js-close-menu"),i=document.querySelectorAll(".mobile-social-box"),l=document.querySelector("body"),a=()=>{const d=e.getAttribute("aria-expanded")==="true"||!1;e.setAttribute("aria-expanded",!d),t.classList.toggle("is-open"),l.classList.toggle("disable-scroll")},n=d=>d.forEach(m=>{m.addEventListener("click",a)});e.addEventListener("click",a),s.addEventListener("click",a),n(i)})();const Z=document.querySelector("#upbutton");Z.addEventListener("click",ee);function ee(){(document.body.scrollTop>0||document.documentElement.scrollTop>0)&&window.scrollTo({top:0,behavior:"smooth"})}window.onscroll=()=>{(window.pageYOffset||document.documentElement.scrollTop)>700?document.getElementById("upbutton").style.display="block":document.getElementById("upbutton").style.display="none"};const $="https://your-energy.b.goit.study/api",B={FILTERS:"filters",EXEECISES:"exercises"},te={Muscles:"muscles","Body parts":"bodypart",Equipment:"equipment"};class P{constructor(e){this.type=e,this.category="Muscles",this.exercise="",this.page=1,this.search=""}setCategory(e){this.category=e}setPage(e){this.page=e}setExercise(e){this.exercise=e}getExercise(){return this.exercise}setSearch(e){this.search=e}async getCategories(){try{return(await w.get(`${$}/filters?filter=${this.category}&page=${this.page}&perPage=12`)).data}catch(e){return console.log(e),e}}async getExercises(){try{const e=await w.get(`${$}/exercises?${te[this.category]}=${this.exercise}&keyword=${this.search}&page=${this.page}&perPage=12`);return console.log(e.data),e.data}catch(e){return console.log(e),e}}async getQuoteOfTheDay(){try{return(await w.get(`${$}/quote`)).data}catch(e){return console.log(e),e}}async subscription(e){try{return(await w.post(`${$}/subscription`,e)).data}catch(s){return s}}}class se{constructor(){}getData(e){try{const s=localStorage.getItem(e);return JSON.parse(s)}catch{console.error("Get error: ",err)}}setData(e,s){try{const i=JSON.stringify(s);localStorage.setItem(e,i)}catch{console.error("Set error: ",err)}}removeData(e){try{localStorage.removeItem(e)}catch{console.error("Remove error: ",err)}}}const re=new P,O=new se,ae=document.querySelector(".quote-text-js"),oe=document.querySelector(".quote-author-js");async function ie(){const t=new Date,e=t.getDate(),s=t.getMonth()+1,i=t.getFullYear(),l=`${e}.${s}.${i}`,a=O.getData("quote");if(a&&a.date===l)Q(a.data);else try{const n=await re.getQuoteOfTheDay(),d={date:l,data:n};O.setData("quote",d),Q(n)}catch(n){console.error("Error fetching the quote:",n)}}function Q(t){ae.textContent=t.quote,oe.textContent=t.author}ie();const ne=new P,U=document.querySelector(".js-footer-form"),u=document.querySelector(".footer-form-btn"),C=document.querySelector('input[type="email"]');function D(t){return/^[^\s@]+(?:\.[^\s@]+)*@[^\s@]+\.[^\s@]+$/.test(t)}u&&(u.disabled=!0,C.addEventListener("input",()=>{const t=C.value;D(t)?(u.style.backgroundColor="#c6cdd1",u.disabled=!1):(u.style.backgroundColor="#f4f4f4",u.disabled=!0)}),u.addEventListener("mouseover",()=>{const t=C.value;D(t)?u.style.cursor="pointer":u.style.cursor="not-allowed"}),u.addEventListener("mouseout",()=>{u.style.cursor="default"}),U.addEventListener("submit",async t=>{var i,l;t.preventDefault();const e=C.value;if(!D(e)){I.warning({message:"Invalid email address was entered.",position:"topRight"});return}const s={email:e};try{const a=await ne.subscription(s);if(console.log("resp",a),((i=a==null?void 0:a.response)==null?void 0:i.status)===409){I.warning({message:"Subscription already exists",position:"topRight"});return}if(((l=a==null?void 0:a.response)==null?void 0:l.status)===400){I.warning({message:"Bad request (invalid request body)",position:"topRight"});return}a!=null&&a.message&&I.success({message:a.message,position:"topRight"})}catch(a){console.log("error",a)}finally{U.reset()}}));const r={paginationBox:document.getElementById("tui-pagination"),categoriesContainer:document.querySelector(".js-categories-container"),categoriesList:document.querySelector(".js-categories-list"),exercise:document.querySelector(".js-exercise"),exerciseDecor:document.querySelector(".js-exercise-decor"),categoryError:document.querySelector(".js-categories-error"),categorySceletonLoader:document.querySelector(".js-sceleton-loader"),search:document.querySelector(".js-search"),exerciseRefresh:document.querySelector(".js-refresh"),searchIcon:document.querySelector(".menu-search-icon"),closeIcon:document.querySelector(".menu-close-icon"),searchBtn:document.querySelector(".menu-search-btn"),searchInput:document.querySelector(".menu-search-input")};r.exerciseRefresh.addEventListener("click",ce);function ce(t){location.reload()}const g="/your-energy/assets/sprite-c1fb1bf2.svg",N=(t,e)=>{const s=t.reduce((i,{filter:l,imgURL:a,name:n})=>(i+=`<li class="categories__card-item js-exercise"
    ...
    `)}function ue(t){t.target.value.trim()&&(t.target.placeholder="")}function G(t){t.target.value.trim()||(t.target.placeholder="Search")}async function Y(t){r.searchBtn.innerHTML=`
      <svg id="menu-search-icon" class="menu-search-icon" width="18" height="18">
        <use href="./img/sprite.svg#icon-search"></use>
      </svg>
